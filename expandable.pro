...
UBUNTU_TRANSLATION_DOMAIN="expandable.liu-xiao-guo"
...
aptest.commands = bash $$PWD/expandable/tests/autopilot/run
aptest.depends  = sub-expandable

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/expandable/tests/unit 
unittest.depends  = sub-expandable
